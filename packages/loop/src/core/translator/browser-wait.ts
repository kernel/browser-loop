import type { BrowserExpectation } from "../actions/index";
...
type RefExpectation = Extract<BrowserExpectation, { type: "ref" }>;
...
function containsLocationExpectation(expectation: BrowserExpectation): boolean {
